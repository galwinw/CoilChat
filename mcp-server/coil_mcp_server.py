...
SERVER_HOST = os.getenv("SERVER_HOST", "0.0.0.0")  # 0.0.0.0 allows external connections
SERVER_PORT = int(os.getenv("SERVER_PORT", "8123"))

# This is ALL you need to run it!
if __name__ == "__main__":
    print(f"[INFO] Starting MCP server in REMOTE mode on {SERVER_HOST}:{SERVER_PORT}", file=sys.stderr)
    print(f"[INFO] Connect from Claude Desktop using: http://YOUR_EC2_IP:{SERVER_PORT}/sse", file=sys.stderr)
